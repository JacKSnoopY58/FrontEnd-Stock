...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./entry-styles.BdC87yIC.mjs').then(interopDefault),
  "Pages/login.vue": () => import('./login-styles.s41_XVS2.mjs').then(interopDefault),
  "Pages/login.vue?vue&type=style&index=0&scoped=b5f85c36&lang.css": () => import('./login-styles.uYTUDtXT.mjs').then(interopDefault),
